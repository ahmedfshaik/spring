...
public class CustomerResourceTest {
    ...
    public void testInsertCustomer() throws Exception {
        ...
        new RestTemplate().postForLocation("http://localhost:9090/spring-rest/customers", entity);
    }
    ...
    public void testReadCustomer() throws Exception {
        ...
        ResponseEntity<Customer> response = new RestTemplate().exchange("http://localhost:9090/spring-rest/customers/{cid}", HttpMethod.GET, entity,
                Customer.class, 1);
